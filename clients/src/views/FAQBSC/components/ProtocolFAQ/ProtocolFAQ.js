          ...
          >
            ...
            <ExpansionPanel expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
              <ExpansionPanelSummary
                ...
                id="panel1bh-header"
              >
                <Typography variant={"h5"} className={classes.heading}>{t('Introduction & Ecosystem')}</Typography>
              </ExpansionPanelSummary>
              <ExpansionPanelDetails>
                <IntroductionFAQ />
                {/* {getWhatIsXwin()} */}
            ...
            <ExpansionPanel expanded={expanded === 'panel8'} onChange={handleChange('panel8')}>
              <ExpansionPanelSummary
                ...
                id="panel8bh-header"
              >
                <Typography variant={"h5"} className={classes.heading}>{t('XVI Token')}</Typography>
              </ExpansionPanelSummary>
              <ExpansionPanelDetails>
                <XwinTokenFAQ />
              </ExpansionPanelDetails>
